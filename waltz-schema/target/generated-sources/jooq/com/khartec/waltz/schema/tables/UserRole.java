...
public class UserRole extends TableImpl<UserRoleRecord> {
    ...
    private static final long serialVersionUID = -492805947;
    ...
    /**
     * The column <code>user_role.user_name</code>.
     */
    public final TableField<UserRoleRecord, String> USER_NAME = createField("user_name", org.jooq.impl.SQLDataType.VARCHAR(255).nullable(false), this, "");

    /**
     * The column <code>user_role.role</code>.
     */
    public final TableField<UserRoleRecord, String> ROLE = createField("role", org.jooq.impl.SQLDataType.VARCHAR(255).nullable(false), this, "");
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.USER_ROLE_USER_ROLE_USER_NAME_FKEY);
    }
    ...
    public List<ForeignKey<UserRoleRecord, ?>> getReferences() {
        return Arrays.<ForeignKey<UserRoleRecord, ?>>asList(Keys.USER_ROLE_USER_NAME_FKEY);
    }
